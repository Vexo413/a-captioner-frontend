    ...
    <section class="demo-card">
      ...
      <div class="demo-flex">
        <div class="video-container">
          <video ref="video" autoplay muted playsinline class="demo-video"></video>
        </div>
        <div class="demo-controls">
          <button class="cta-button" @click="startRecording">Ask</button>
      ...
      <p class="demo-tip">Show an object to your webcam and ask a question!</p>
    </section>
  </div>
</template>
...
const audioUrl = ref('')
const BASE_URL = 'https://parkers-macbook-pro.tailc7ffa3.ts.net'
...
const startRecording = async () => {
  ...
  const audioRes = await fetch(`${BASE_URL}/${data.audio_file}`, {
    headers: { 'bypass-tunnel-reminder': 'true' },
  })
  const audioBlob2 = await audioRes.blob()
  const audioUrlObject = URL.createObjectURL(audioBlob2)

  audioUrl.value = audioUrlObject
}
